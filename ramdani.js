...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ʙʏ KrisnaXD","listType": "SINGLE_SELECT","sections": list}}, {})
...
> 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© KrisnaXD', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
break
      ...
      qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
               ...
               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '© ʙʏ KrisnaXD', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© ʙʏ KrisnaXD* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
